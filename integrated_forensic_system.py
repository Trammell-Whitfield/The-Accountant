...
from benfords_law_enhanced import BenfordsLawAnalyzer
from statistical_fraud_detection import StatisticalFraudDetector
from synthetic_ledgers import ImprovedSyntheticLedgerGenerator
...
class IntegratedForensicSystem:
    ...
    def __init__(self, knowledge_base_path: str = "forensic_knowledge.db"):
        ...
        self.rag_analyzer = ForensicRAGAnalyzer(knowledge_base_path)
